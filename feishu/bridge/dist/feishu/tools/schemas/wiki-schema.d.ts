...
export declare const FeishuWikiSchema: import("@sinclair/typebox").TUnion<[import("@sinclair/typebox").TObject<{
    ...
    action: import("@sinclair/typebox").TLiteral<"import_to_wiki">;
    space_id: import("@sinclair/typebox").TString;
    obj_token: import("@sinclair/typebox").TString;
    obj_type: import("@sinclair/typebox").TString;
    parent_wiki_token: import("@sinclair/typebox").TOptional<import("@sinclair/typebox").TString>;
}>, import("@sinclair/typebox").TObject<{
