...
export async function listFields(client: Lark.Client, appToken: string, tableId: string) {
...
export async function listRecords(client: Lark.Client, appToken: string, tableId: string, pageSize?: number, pageToken?: string) {
...
export async function getRecord(client: Lark.Client, appToken: string, tableId: string, recordId: string) {
...
export async function createRecord(client: Lark.Client, appToken: string, tableId: string, fields: Record<string, unknown>) {
...
export async function updateRecord(client: Lark.Client, appToken: string, tableId: string, recordId: string, fields: Record<string, unknown>) {
...
export async function createField(client: Lark.Client, appToken: string, tableId: string, fieldName: string, fieldType: number, property?: Record<string, unknown>) {
...
export async function createApp(client: Lark.Client, name: string, folderToken?: string) {
...
export async function batchCreateRecords(client: Lark.Client, appToken: string, tableId: string, records: Record<string, unknown>[]) {
  const res = await (client.bitable.appTableRecord as any).batchCreate({
    path: { app_token: appToken, table_id: tableId },
...
export async function batchDeleteRecords(client: Lark.Client, appToken: string, tableId: string, recordIds: string[]) {
  const res = await (client.bitable.appTableRecord as any).batchDelete({
    path: { app_token: appToken, table_id: tableId },
...
export async function renameField(client: Lark.Client, appToken: string, tableId: string, fieldId: string, fieldName: string) {
  ...
  if (getRes.code !== 0) throw new Error(getRes.msg);
...
export async function deleteField(client: Lark.Client, appToken: string, tableId: string, fieldId: string) {
...
export async function createView(client: Lark.Client, appToken: string, tableId: string, viewName: string, viewType: string = "grid") {
  const res = await (client.bitable.appTableView as any).create({
    path: { app_token: appToken, table_id: tableId },
...
export async function deleteRecord(client: Lark.Client, appToken: string, tableId: string, recordId: string) {
