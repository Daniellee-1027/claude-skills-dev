...
export const FeishuWikiSchema = Type.Union([
  ...
  Type.Object({
    action: Type.Literal("import_to_wiki"),
    space_id: Type.String({ description: "Target knowledge space ID" }),
    obj_token: Type.String({ description: "Cloud document token to import (e.g. bitable app_token or docx token)" }),
    obj_type: Type.String({ description: "Object type: doc, sheet, bitable, file, docx, slides, mindnote" }),
    parent_wiki_token: Type.Optional(Type.String({ description: "Parent wiki node token (optional, root if omitted)" })),
  }),
  Type.Object({
