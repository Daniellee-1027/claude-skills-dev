...
export function createFeishuToolHandlers(params: {
...
}): Map<string, { handler: ToolHandler; description: string; inputSchema: any }> {
  const { client, toolsConfig } = params;
  const tools = new Map<string, { handler: ToolHandler; description: string; inputSchema: any }>();
  ...
  if (toolsConfig?.doc !== false) {
    tools.set("feishu_doc", {
      ...
      handler: async (p: any) => {
        ...
        } catch (err: any) { return json({ error: err.message ?? String(err) }); }
      },
    });
  }
  ...
  if (toolsConfig?.bitable !== false) {
    tools.set("feishu_bitable_get_meta", {
      ...
      handler: async (p: any) => {
        try { return json(await bitableTools.getBitableMeta(client, p.url)); }
        catch (err: any) { return json({ error: err.message ?? String(err) }); }
      },
    });
    ...
    tools.set("feishu_bitable_list_fields", {
      ...
      handler: async (p: any) => {
        try { return json(await bitableTools.listFields(client, p.app_token, p.table_id)); }
        catch (err: any) { return json({ error: err.message ?? String(err) }); }
      },
    });
    ...
    tools.set("feishu_bitable_list_records", {
      ...
      handler: async (p: any) => {
        try { return json(await bitableTools.listRecords(client, p.app_token, p.table_id, p.page_size, p.page_token)); }
        catch (err: any) { return json({ error: err.message ?? String(err) }); }
      },
    });
    ...
    tools.set("feishu_bitable_get_record", {
      ...
      handler: async (p: any) => {
        try { return json(await bitableTools.getRecord(client, p.app_token, p.table_id, p.record_id)); }
        catch (err: any) { return json({ error: err.message ?? String(err) }); }
      },
    });
    ...
    tools.set("feishu_bitable_create_record", {
      ...
      handler: async (p: any) => {
        try { return json(await bitableTools.createRecord(client, p.app_token, p.table_id, p.fields)); }
        catch (err: any) { return json({ error: err.message ?? String(err) }); }
      },
    });
    ...
    tools.set("feishu_bitable_update_record", {
      ...
      handler: async (p: any) => {
        try { return json(await bitableTools.updateRecord(client, p.app_token, p.table_id, p.record_id, p.fields)); }
        catch (err: any) { return json({ error: err.message ?? String(err) }); }
      },
    });
    ...
    tools.set("feishu_bitable_delete_record", {
      ...
      inputSchema: { type: "object", properties: { app_token: { type: "string" }, table_id: { type: "string" }, record_id: { type: "string" } }, required: ["app_token", "table_id", "record_id"] },
      handler: async (p: any) => {
        try { return json(await bitableTools.deleteRecord(client, p.app_token, p.table_id, p.record_id)); }
        catch (err: any) { return json({ error: err.message ?? String(err) }); }
      },
    });
    ...
    tools.set("feishu_bitable_create_app", {
      ...
      handler: async (p: any) => {
        try { return json(await bitableTools.createApp(client, p.name, p.folder_token)); }
        catch (err: any) { return json({ error: err.message ?? String(err) }); }
      },
    });
    ...
    tools.set("feishu_bitable_create_field", {
      ...
      handler: async (p: any) => {
        try { return json(await bitableTools.createField(client, p.app_token, p.table_id, p.field_name, p.field_type, p.property)); }
        catch (err: any) { return json({ error: err.message ?? String(err) }); }
      },
    });
    ...
    tools.set("feishu_bitable_import_csv", {
      ...
      handler: async (p: any) => {
        try { return json(await importCSVToBitable(client, p.csv_path, p.table_name, p.field_overrides, p.wiki_space_id, p.wiki_parent_node_token)); }
        catch (err: any) { return json({ error: err.message ?? String(err) }); }
      },
    });
    ...
    tools.set("feishu_bitable_batch_create_records", {
      ...
      handler: async (p: any) => {
        try { return json(await bitableTools.batchCreateRecords(client, p.app_token, p.table_id, p.records)); }
        catch (err: any) { return json({ error: err.message ?? String(err) }); }
      },
    });
    ...
    tools.set("feishu_bitable_batch_delete_records", {
      ...
      handler: async (p: any) => {
        try { return json(await bitableTools.batchDeleteRecords(client, p.app_token, p.table_id, p.record_ids)); }
        catch (err: any) { return json({ error: err.message ?? String(err) }); }
      },
    });
    ...
    tools.set("feishu_bitable_rename_field", {
      ...
      handler: async (p: any) => {
        try { return json(await bitableTools.renameField(client, p.app_token, p.table_id, p.field_id, p.field_name)); }
        catch (err: any) { return json({ error: err.message ?? String(err) }); }
      },
    });
    ...
    tools.set("feishu_bitable_delete_field", {
      ...
      handler: async (p: any) => {
        try { return json(await bitableTools.deleteField(client, p.app_token, p.table_id, p.field_id)); }
        catch (err: any) { return json({ error: err.message ?? String(err) }); }
      },
    });
    ...
    tools.set("feishu_bitable_create_view", {
      ...
      handler: async (p: any) => {
        try { return json(await bitableTools.createView(client, p.app_token, p.table_id, p.view_name, p.view_type)); }
        catch (err: any) { return json({ error: err.message ?? String(err) }); }
      },
    });
  }
